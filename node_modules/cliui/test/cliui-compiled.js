...
describe('cliui', function () {
  ...
  describe('border', function () {
    it('allows a border to be placed around a div', function () {
      ...
      ui.div({ text: 'i am a first string', padding: [0, 0, 0, 0], border: true }, { text: 'i am a second string', padding: [1, 0, 0, 0], border: true });
  ...
  describe('span', function () {
    ...
    it('appends to prior line appropriately when strings contain ansi escape codes', function () {
      ...
      ui.span({ text: chalk.green('i am a string that will be wrapped'), width: 30 });

      ui.div({ text: chalk.blue(' [required] [default: 99]'), align: 'right' });
