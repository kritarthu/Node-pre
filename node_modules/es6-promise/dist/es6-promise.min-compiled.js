...
(function () {
  "use strict";function t(t) {
    ...
    try {
      var t = require,
          e = t("vertx");return (U = e.runOnLoop || e.runOnContext, i());
    } catch (n) {
      return c();
    }
  }function l(t, e) {
    ...
    var e = t._subscribers,
      ...
      for (var r, o, i = t._result, s = 0; s < e.length; s += 3) r = e[s], o = e[s + n], r ? C(n, r, o, i) : o(i);t._subscribers.length = 0;
    }
  }function P() {
    this.error = null;
  }function x(t, e) {
    ...
    function e(t) {
      ...
      S(o, t);
        ...
        o = new r(p);if (!B(t)) return (S(o, new TypeError("You must pass an array to race.")), o);for (var i = t.length, s = 0; o._state === tt && i > s; s++) j(r.resolve(t[s]), void 0, e, n);return o;
  }function Y(t) {
    var e = this,
    ...
    X[G] = t, X[G + 1] = e, G += 2, 2 === G && (W ? W(a) : z());
      ...
      X = new Array(1e3);z = R ? o() : Q ? s() : V ? u() : void 0 === I && "function" == typeof require ? f() : c();var Z = l,
      $ = h,
      tt = void 0,
      et = 1,
      nt = 2,
    ...
    var n = this;j(t, void 0, function (t) {
      ...
      ht = { Promise: at, polyfill: lt };"function" == typeof define && define.amd ? define(function () {
    return ht;
  }) : "undefined" != typeof module && module.exports ? module.exports = ht : "undefined" != typeof this && (this.ES6Promise = ht), lt();
}).call(undefined);

//# sourceMappingURL=es6-promise.min-compiled.js.map