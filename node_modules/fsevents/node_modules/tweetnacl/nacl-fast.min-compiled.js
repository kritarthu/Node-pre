...
!(function (r) {
  "use strict";function t(r, t, n, e) {
    ...
    var n,
        ...
        o,
        i = $(),
        h = $();for (n = 0; 16 > n; n++) h[n] = t[n];for (b(h), b(h), b(h), e = 0; 2 > e; e++) {
      for (i[0] = h[0] - 65517, n = 1; 15 > n; n++) i[n] = h[n] - 65535 - (i[n - 1] >> 16 & 1), i[n - 1] &= 65535;i[15] = h[15] - 32767 - (i[14] >> 16 & 1), o = i[15] >> 16 & 1, i[14] &= 65535, d(h, i, 1 - o);
    ...
    var e,
        ...
        u = $(),
        c = $(),
        y = $();for (o = 0; 31 > o; o++) i[o] = t[o];for (i[31] = 127 & t[31] | 64, i[0] &= 248, E(h, n), o = 0; 16 > o; o++) f[o] = h[o], u[o] = a[o] = s[o] = 0;for (a[0] = u[0] = 1, o = 254; o >= 0; --o) e = i[o >>> 3] >>> (7 & o) & 1, d(a, f, e), d(s, u, e), x(c, a, s), M(a, a, s), x(s, f, u), M(f, f, u), B(u, c), B(y, a), m(a, s, a), m(s, f, c), x(c, a, s), M(a, a, s), B(f, a), M(s, u, y), m(a, s, ir), x(a, a, u), m(s, s, a), m(a, u, y), m(u, f, h), B(f, c), d(a, f, e), d(s, u, e);for (o = 0; 16 > o; o++) h[o + 16] = a[o], h[o + 32] = s[o], h[o + 48] = f[o], h[o + 64] = u[o];var l = h.subarray(32),
    ...
    for (var o, i, h, a, f, s, u, c, y, l, w, p, g, v, b, d, A, _, U, E, x, M, m, B, S, K, T = new Int32Array(16), Y = new Int32Array(16), k = r[0], L = r[1], C = r[2], R = r[3], z = r[4], P = r[5], O = r[6], N = r[7], F = t[0], I = t[1], j = t[2], G = t[3], Z = t[4], V = t[5], q = t[6], X = t[7], D = 0; e >= 128;) {
    ...
    var o,
        ...
        f = e;for (i[0] = 1779033703, i[1] = 3144134277, i[2] = 1013904242, i[3] = 2773480762, i[4] = 1359893119, i[5] = 2600822924, i[6] = 528734635, i[7] = 1541459225, h[0] = 4089235720, h[1] = 2227873595, h[2] = 4271175723, h[3] = 1595750129, h[4] = 2917565137, h[5] = 725511199, h[6] = 4215389547, h[7] = 327033209, z(i, h, n, e), e %= 128, o = 0; e > o; o++) a[o] = n[f - e + o];for (a[e] = 128, e = 256 - 128 * (112 > e ? 1 : 0), a[e - 9] = 0, t(a, e - 8, f / 536870912 | 0, f << 3), z(i, h, a, e), o = 0; 8 > o; o++) t(r, 8 * o, i[o], h[o]);return 0;
  }function O(r, t) {
    var n = $(),
        e = $(),
        o = $(),
    ...
    var e;for (e = 0; 4 > e; e++) d(r[e], t[e], n);
  }function F(r, t) {
    var n = $(),
        e = $(),
        o = $();S(o, t[2]), m(n, t[0], o), m(e, t[1], o), A(r, e), r[31] ^= U(n) << 7;
  }function I(r, t, n) {
    var e, o;for (v(r[0], er), v(r[1], or), v(r[2], or), v(r[3], er), o = 255; o >= 0; --o) e = n[o / 8 | 0] >> (7 & o) & 1, N(r, t, e), O(t, r), O(r, r), N(r, t, e);
  }function j(r, t) {
    var n = [$(), $(), $(), $()];v(n[0], fr), v(n[1], sr), v(n[2], or), m(n[3], fr, sr), I(r, n, t);
  }function G(r, t, n) {
    var e,
        o = new Uint8Array(64),
        i = [$(), $(), $(), $()];for (n || rr(t, 32), P(o, t, 32), o[0] &= 248, o[31] &= 127, o[31] |= 64, j(i, o), F(r, i), e = 0; 32 > e; e++) t[e + 32] = r[e];return 0;
  }function Z(r, t) {
    var n, e, o, i;for (e = 63; e >= 32; --e) {
      for (n = 0, o = e - 32, i = e - 12; i > o; ++o) t[o] += n - 16 * t[e] * gr[o - (e - 32)], n = t[o] + 128 >> 8, t[o] -= 256 * n;t[o] += n, t[e] = 0;
    }for (n = 0, o = 0; 32 > o; o++) t[o] += n - (t[31] >> 4) * gr[o], n = t[o] >> 8, t[o] &= 255;for (o = 0; 32 > o; o++) t[o] -= n * gr[o];for (e = 0; 32 > e; e++) t[e + 1] += t[e] >> 8, r[e] = 255 & t[e];
  }function V(r) {
    var t,
        n = new Float64Array(64);for (t = 0; 64 > t; t++) n[t] = r[t];for (t = 0; 64 > t; t++) r[t] = 0;Z(r, n);
  }function q(r, t, n, e) {
    var o,
        i,
        h = new Uint8Array(64),
        ...
        u = [$(), $(), $(), $()];P(h, e, 32), h[0] &= 248, h[31] &= 127, h[31] |= 64;var c = n + 64;for (o = 0; n > o; o++) r[64 + o] = t[o];for (o = 0; 32 > o; o++) r[32 + o] = h[32 + o];for (P(f, r.subarray(32), n + 32), V(f), j(u, f), F(r, u), o = 32; 64 > o; o++) r[o] = e[o];for (P(a, r, n + 64), V(a), o = 0; 64 > o; o++) s[o] = 0;for (o = 0; 32 > o; o++) s[o] = f[o];for (o = 0; 32 > o; o++) for (i = 0; 32 > i; i++) s[o + i] += a[o] * h[i];return (Z(r.subarray(32), s), c);
  }function X(r, t) {
    var n = $(),
        e = $(),
        o = $(),
        ...
        h = $(),
        a = $(),
        f = $();return (v(r[2], or), E(r[1], t), B(o, r[1]), m(i, o, hr), M(o, o, r[2]), x(i, r[2], i), B(h, i), B(a, h), m(f, a, h), m(n, f, o), m(n, n, i), K(n, n), m(n, n, o), m(n, n, i), m(n, n, i), m(r[0], n, i), B(e, r[0]), m(e, e, i), _(e, o) && m(r[0], r[0], ur), B(e, r[0]), m(e, e, i), _(e, o) ? -1 : (U(r[0]) === t[31] >> 7 && M(r[0], er, r[0]), m(r[3], r[0], r[1]), 0));
  }function D(r, t, n, e) {
    var i,
        h,
        a = new Uint8Array(32),
        f = new Uint8Array(64),
        s = [$(), $(), $(), $()],
        u = [$(), $(), $(), $()];if ((h = -1, 64 > n)) return -1;if (X(u, e)) return -1;for (i = 0; n > i; i++) r[i] = t[i];for (i = 0; 32 > i; i++) r[i + 32] = e[i];if ((P(f, r, n), V(f), I(s, u, f), j(u, t.subarray(32)), O(s, u), F(a, s), n -= 64, o(t, 0, a, 0))) {
      for (i = 0; n > i; i++) r[i] = 0;return -1;
    }for (i = 0; n > i; i++) r[i] = t[i + 64];return h = n;
  }function H(r, t) {
    if (r.length !== vr) throw new Error("bad key size");if (t.length !== br) throw new Error("bad nonce size");
  }function J(r, t) {
    ...
    if ((Q(r, t), t.length !== Yr)) throw new Error("bad secret key size");var n = new Uint8Array(Kr + r.length);return (q(n, r, r.length, t), n);
    ...
    var r = new Uint8Array(Tr),
        t = new Uint8Array(Yr);return (G(r, t), { publicKey: r, secretKey: t });
    ...
    if ((Q(r), r.length !== kr)) throw new Error("bad seed size");for (var t = new Uint8Array(Tr), n = new Uint8Array(Yr), e = 0; 32 > e; e++) n[e] = r[e];return (G(t, n, !0), { publicKey: t, secretKey: n });
  }, r.sign.publicKeyLength = Tr, r.sign.secretKeyLength = Yr, r.sign.seedLength = kr, r.sign.signatureLength = Kr, r.hash = function (r) {
    Q(r);var t = new Uint8Array(Lr);return (P(t, r, r.length), t);
    ...
    var t;"undefined" != typeof window ? (window.crypto && window.crypto.getRandomValues ? t = window.crypto : window.msCrypto && window.msCrypto.getRandomValues && (t = window.msCrypto), t && r.setPRNG(function (r, n) {
      var e,
          o = new Uint8Array(n);for (t.getRandomValues(o), e = 0; n > e; e++) r[e] = o[e];W(o);
