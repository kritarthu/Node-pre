...
test('sync tests', function (t) {
  t.plan(7);
  var throws = function throws(shouldthrow, msg, todo) {
    var err;
    try {
      todo();
    } catch (e) {
  ...
  var noexception = function noexception(msg, todo) {
    var err;
    try {
      todo();
    } catch (e) {
